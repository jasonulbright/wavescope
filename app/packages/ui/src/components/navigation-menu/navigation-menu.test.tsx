            ...
            <NavigationMenu.Content>
              <NavigationMenu.Menu size="image" layout="columns">
                <NavigationMenu.Group>
                  ...
                  <MediaRow title="Create Image" subtitle="Image generation" href="/image" />
                </NavigationMenu.Group>
              </NavigationMenu.Menu>
            </NavigationMenu.Content>
          </NavigationMenu.Item>
    ...
    render(
      <NavigationMenu.Menu standalone size="plugins" layout="columns">
        <NavigationMenu.Group>
          ...
          <MediaRow title="Premiere Pro" subtitle="Editing inside Premiere" href="/premiere" interactive={false} />
        </NavigationMenu.Group>
      </NavigationMenu.Menu>,
    )
