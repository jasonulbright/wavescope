...
import { IconCrossMediumOutlined as ClearIcon } from '@wavescope/icons/IconCrossMediumOutlined'
import { IconMagnifyingGlass2Outlined as SearchIcon } from '@wavescope/icons/IconMagnifyingGlass2Outlined'
 ...
 * portal + positioning, and all `data-*` state). ws-ui only paints: the input
 * is the canonical ws-ui field surface (white-5%, radius 12, lime focus ring),
...
/* ── Input ───────────────────────────────────────────────────────────────────
 * The ws-ui field surface (q-field-control) wrapping the Base UI Input, with a
