 ...
 *
 * This is the TINT pattern — one of ws-ui's two coloring models. It fits soft
 ...
 * use which: see slot.css.
 *
 * CONTRACT: every value references an `--ws-color-*` runtime primitive (emitted
 ...
 * transparent. See ws-ui-core-plan.md §5.4 / §5.4.1.
 */
...
const FALLBACK = 'var(--ws-color-brand-primary)'
...
/** color → the four `--q-tint*` properties (all sourced from `--ws-color-*`). */
export const SLOT: Record<SlotColor, SlotVars> = {
  brand: {
    '--q-tint': 'var(--ws-color-brand-primary)',
    '--q-tint-fg': 'var(--ws-color-text-inverse)',
  },
  neutral: {
    '--q-tint': `var(--ws-color-text-primary, ${FALLBACK})`,
    '--q-tint-bg': `var(--ws-color-background-secondary-strong, ${FALLBACK})`,
    '--q-tint-fg': 'var(--ws-color-text-primary)',
    '--q-tint-border': `var(--ws-color-border-strong, ${FALLBACK})`,
  },
  success: {
    '--q-tint': `var(--ws-color-state-success-fg, ${FALLBACK})`,
    '--q-tint-fg': 'var(--ws-color-text-inverse)',
  },
  error: {
    '--q-tint': `var(--ws-color-state-error-fg, ${FALLBACK})`,
    '--q-tint-fg': 'var(--ws-color-text-inverse)',
  },
  warning: {
    '--q-tint': `var(--ws-color-state-warning-fg, ${FALLBACK})`,
    '--q-tint-fg': 'var(--ws-color-text-inverse)',
  },
  info: {
    '--q-tint': `var(--ws-color-state-info-fg, ${FALLBACK})`,
    '--q-tint-fg': 'var(--ws-color-text-inverse)',
  },
}
