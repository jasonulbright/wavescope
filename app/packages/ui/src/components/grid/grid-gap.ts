/**
 * Shared grid gap scale — the native Tailwind spacing steps ws-ui exposes for
...
/** 1..24 — the native Tailwind gap scale steps ws-ui exposes. */
...
// Native Tailwind spacing: step × 0.25rem = step × 4px at the 16px root ws-ui
