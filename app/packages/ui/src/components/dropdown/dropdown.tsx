...
import { IconCheckmark2MediumOutlined as CheckIcon } from '@wavescope/icons/IconCheckmark2MediumOutlined'
import { IconChevronRightMediumOutlined as ChevronRightIcon } from '@wavescope/icons/IconChevronRightMediumOutlined'
 ...
 * skinned with ws-ui's `q-dropdown-*` presentation utilities (see
