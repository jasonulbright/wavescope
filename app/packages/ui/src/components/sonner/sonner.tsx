...
import { IconCircleCheckOutlined as SuccessGlyph } from '@wavescope/icons/IconCircleCheckOutlined'
import { IconCircleInfoOutlined as InfoGlyph } from '@wavescope/icons/IconCircleInfoOutlined'
import { IconCircleXOutlined as ErrorGlyph } from '@wavescope/icons/IconCircleXOutlined'
import { IconExclamationTriangleOutlined as WarningGlyph } from '@wavescope/icons/IconExclamationTriangleOutlined'
import { CloseIcon } from '../close-button/index.ts'
import { Icon } from '../icon/index.ts'
import { cx } from '../utils/cx.ts'

/**
 * Sonner — an opinionated toast system on Base UI Toast, skinned with ws-ui
 ...
 * focus and a11y — ws-ui only paints.
 *
 *   import { Toaster, toast } from '@wavescope/ui/sonner'
...
interface SonnerData {
  ...
  icon?: ReactNode
  /** A custom action node (e.g. a ws-ui Button) — overrides the simple action button. */
  action?: ReactNode
}
...
interface ToastOptions {
   ...
   * `ReactNode` (e.g. a ws-ui `Button`, a link, or several buttons).
   */
...
function Glyph({ variant }: { variant: SonnerVariant }) {
  // The status glyphs come from @wavescope/icons; <Icon size="md"> = 20px,
