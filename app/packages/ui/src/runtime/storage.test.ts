...
describe('Side-effect contract', () => {
  ...
  describe('urlAdapter (search mode)', () => {
    ...
    it('writes to ?search and reads back', () => {
      ...
      adapter.set('theme', 'ocean')
      expect(window.location.search).toContain('theme=ocean')
      expect(adapter.get('theme')).toBe('ocean')
    })
  ...
  describe('urlAdapter (hash mode)', () => {
    ...
    it('writes to #hash, not ?search', () => {
      ...
      adapter.set('theme', 'ocean')
      expect(window.location.hash).toContain('theme=ocean')
