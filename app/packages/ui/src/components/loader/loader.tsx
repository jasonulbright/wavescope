...
/**
 * Loader — an indeterminate loading indicator, slot-tinted with the ws-ui
 ...
 *   - `stars`  — twinkling sparkles, the sparkle motif (cf. specialBrand).
...
/** Four-point sparkle. Scales with the loader box. */
