 ...
 * Pure ws-ui (no Base UI primitive); the host element is swappable via `render`
...
/** Radius token step (matches `--ws-radius-*`). */
...
export interface GlassOptions {
  ...
  /** Corner radius token step. Default '600' (24px — the ws-ui surface radius). */
