...
import { IconChevronLeftMediumOutlined as ChevronLeftIcon } from '@wavescope/icons/IconChevronLeftMediumOutlined'
 ...
 * exit-mount timing) skinned with ws-ui tokens, pixel-matched to the Figma
...
/* ── Passthrough parts (Base UI owns behavior; ws-ui only names them). ─────── */
