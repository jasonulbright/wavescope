...
import { IconChevronDownMediumOutlined } from '@wavescope/icons/IconChevronDownMediumOutlined'
import { Icon } from '../icon/index.ts'
import { cx } from '../utils/cx.ts'

/**
 * Accordion — Base UI `accordion` (roving focus, keyboard, ARIA, the
 * `--accordion-panel-height` collapse var) skinned with ws-ui. Base UI owns all
 * behaviour/state/`data-*`; ws-ui only paints + forwards `className`/`ref`.
 *
