 ...
 * portal + positioning, hidden form input), skinned with ws-ui tokens.
 *
 ...
 *
 *   <Select.Root defaultValue="aurora" onValueChange={setModel}>
 *     <Select.Trigger>
 ...
 *         <Select.Item value="aurora">
 *           <Select.ItemIcon><Icon /></Select.ItemIcon>
 *           <Select.ItemText>Aurora 2.0</Select.ItemText>
...
type TriggerProps = Omit<ComponentProps<typeof Primitive.Trigger>, 'className'> & {
   ...
   * styling. Use when the trigger is another ws-ui control, e.g. the builder
